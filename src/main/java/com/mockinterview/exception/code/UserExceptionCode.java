...
public enum UserExceptionCode {
    ...
    INVALID_EXPERIENCE_LEVEL(HttpStatus.BAD_REQUEST, "유효하지 않은 경력 수준입니다. (JUNIOR, MIDDLE, SENIOR)"),
    INVALID_TECH_FIELD(HttpStatus.BAD_REQUEST, "유효하지 않은 분야입니다. (FRONTEND, BACKEND)");
